...
package com.common.sdk.widget.drawable;
...
public class CustomePressedDrawable extends Drawable {
    ...
    public CustomePressedDrawable(View view, int type,
    ...
    public CustomePressedDrawable(int type, int width, int bgcolor, int maskColor, int duration, int startAlpha, int endAlpha) {
        mType = type;
