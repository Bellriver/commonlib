...
package com.common.sdk.widget.customeswitch;
...
public class Switch extends CompoundButton implements AnimHelper.ThumbPositionListener{
    ...
    */
    ...
    public Switch(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.Switch);
    }
    ...
    public Switch(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        */
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.SdkSwitch, defStyleAttr, 0);
        mThumbDrawable = a.getDrawable(R.styleable.SdkSwitch_thumb);
        ...
        mTrackDrawable = a.getDrawable(R.styleable.SdkSwitch_track);
        ...
        */
        mSwitchMinWidth = a.getDimensionPixelSize(
                R.styleable.SdkSwitch_switchMinWidth, 0);
        mSwitchPadding = a.getDimensionPixelSize(
                R.styleable.SdkSwitch_switchPadding, 0);
        mSplitTrack = a.getBoolean(R.styleable.SdkSwitch_splitTrack, false);
    ...
    */
    ...
    private void initBgDrawParams(){
        mBgPaint = new Paint();
        mBgPaint.setColor(this.getContext().getResources().getColor(R.color.switch_bg_color));
        mBgPaint.setAntiAlias(true);

        mBgPath = new Path();
        int width = this.getContext().getResources().getDimensionPixelSize(R.dimen.switch_bg_width);
        int height = this.getContext().getResources().getDimensionPixelSize(R.dimen.switch_bg_height);
